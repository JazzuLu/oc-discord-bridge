...
- `DISCORD_FORWARD_TRIGGER_MODE` (default: `off`; values: `off` | `mention` | `prefix` | `mention_or_prefix`)
- `DISCORD_FORWARD_TRIGGER_PREFIX` (default: `!oc `; used when trigger mode is `prefix` / `mention_or_prefix`)
